...
//const byte displayDataBufferSize       		= 23;		// Size of display data buffer
//const byte displayDataBits             		= 22;       // 0-38 bits length of display data within a cycle
//const byte buttonDataBits              		= 2;        // 0-2 bits length of button data within a cycle
const byte totalDataBits               		= 23;       // 0-41 total number of pulses within a cycle
...
class BalboaInterface {
  ...
  public:
	...
	BalboaInterface(byte setClockPin, byte setReadPin, byte setLightPin);
  ...
  private:
	...
	String lookup_LCD_character(int LCD_character);
	int LCD_segment_1;
	int LCD_segment_2;
	//int LCD_segment_3;
	//int LCD_segment_4;
